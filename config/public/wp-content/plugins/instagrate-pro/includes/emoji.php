...
function igp_emoji_docomo_to_unified( $text){ return igp_emoji_convert($text, 'docomo_to_unified'); }
function igp_emoji_kddi_to_unified( $text){ return igp_emoji_convert($text, 'kddi_to_unified'); }
function igp_emoji_softbank_to_unified( $text){ return igp_emoji_convert($text, 'softbank_to_unified'); }
function igp_emoji_google_to_unified( $text){ return igp_emoji_convert($text, 'google_to_unified'); }
...
function igp_emoji_unified_to_docomo( $text){ return igp_emoji_convert($text, 'unified_to_docomo'); }
function igp_emoji_unified_to_kddi( $text){ return igp_emoji_convert($text, 'unified_to_kddi'); }
function igp_emoji_unified_to_softbank( $text){ return igp_emoji_convert($text, 'unified_to_softbank'); }
function igp_emoji_unified_to_google( $text){ return igp_emoji_convert($text, 'unified_to_google'); }
function igp_emoji_unified_to_html( $text){ return igp_emoji_convert($text, 'unified_to_html'); }
function igp_emoji_html_to_unified( $text){ return igp_emoji_convert($text, 'html_to_unified'); }
function igp_emoji_html_stripped( $text){ return igp_emoji_convert($text, 'emoji_html_stripped'); }
